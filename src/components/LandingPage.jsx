...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Hero Section */}
      <div className="relative h-[70vh] w-full bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="absolute inset-0">
          <div className="h-full w-full bg-gradient-to-r from-indigo-600/20 to-purple-600/20" />
        </div>
        <div className="relative h-full w-full px-4 sm:px-6 lg:px-8 flex items-center justify-center">
